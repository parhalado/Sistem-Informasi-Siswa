...
<head>
	<title>Login | Sistem Informasi Data Siswa</title>
	<meta charset="utf-8">
			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
								<div class="logo text-center"><img src="{{ asset('admin/DS.ico') }}" alt="Holan hita Logo"></div>
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">Sistem Informasi Data Siswa</h1>
							<p>by Holan Hita</p>
						</div>
					</div>
